...
<main class="d-flex align-items-center justify-content-center">
  <form class="p-5 bg-black text-white rounded-4 w-50 needs-validation" id="itemForm" method="post"
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" id="chapters" name="chapters" min="1" max="2000" step="1" required
    ...
    <div class="mb-3">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="types" id="fiction" value="Fiction" required />
        <label class="form-check-label" for="fiction">Manga</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="types" id="non-fiction" value="Non-Fiction" required />
        <label class="form-check-label" for="non-fiction">Manhwa</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="types" id="mystery" value="Mystery" required />
    ...
    <div class="mb-3">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre1" value="Adventure" />
        <label class="form-check-label" for="genre1">Adventure</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre2" value="Romance" />
        <label class="form-check-label" for="genre2">Romance</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre3" value="Science Fiction" />
        <label class="form-check-label" for="genre3">Science Fiction</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre4" value="Slice Of Life" />
        <label class="form-check-label" for="genre4">Slice Of Life</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre5" value="Shounen" />
        <label class="form-check-label" for="genre5">Shounen</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre6" value="Gore" />
        <label class="form-check-label" for="genre6">Gore</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre7" value="Action" />
        <label class="form-check-label" for="genre7">Action</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre8" value="Isekai" />
        <label class="form-check-label" for="genre8">Isekai</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="genre[]" id="genre9" value="Time Travel" />
        <label class="form-check-label" for="genre9">Time Travel</label>
      </div>
    </div>
    <div class="mb-3">
      <label for="author" class="form-label">Author</label>
      <input type="text" class="form-control" id="author" name="author" required oninput="validateAuthorInput()" />
      <span class="text-danger" id="authorError"></span>
    </div>
    <div class="mb-3">
      <label for="languageManga" class="form-label">Language</label>
      <input type="text" class="form-control" id="languageManga" name="language" required
    ...
    <div class="mb-3">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="availability" id="available" value="Available" required />
    ...
    <div class="mb-3">
      ...
      <input type="file" class="form-control" id="cover-image" name="cover-image" accept="image/*" />
    </div>
